...
export function FilterBar({ filters, onChange }: FilterBarProps) {
  ...
  return (
    <div className="grid gap-3 rounded-[14px] border border-[#CFE0F7] bg-[#F7FAFF] p-4 shadow-[0_1px_2px_rgba(15,23,42,0.06),0_16px_38px_rgba(37,99,235,0.08)] md:grid-cols-5">
      <Select label="Branch" value={filters.branch} onChange={set('branch')} options={['All', 'CSE', 'ECE', 'ME', 'Civil'].map((value) => ({ value, label: value }))} />
